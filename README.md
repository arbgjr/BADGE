...
Após ler o passo a passo abaixo você pode executar a [configuração/instalação automatizada](#automatizando-a-instalação), que fará a configuração do ambiente local e a criação dos recursos no Azure.
