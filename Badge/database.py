...
class Database:
        ...
        try:
            with self.connect() as client:
                ...
                if template_data:
                    ...
                    self.logger.log(self.LogLevel.WARNING, f"Nenhum template encontrado para o emissor '{issuer_name}' na área '{area_name}'.")
                    return None
        except Exception as e:
            stack_trace = traceback.format_exc()
    ...
    def insert_badge_json(self, badge_json):
        try:
            ...
            stack_trace = traceback.format_exc()
            self.logger.log(self.LogLevel.ERROR, f"Erro ao inserir JSON da insígnia no banco de dados: {e}\nStack Trace:\n{stack_trace}")
            return None
